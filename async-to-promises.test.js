...
compiledTest("call chains", {
	...
	output: `__async(function(a,b,c){return __call(b,function(_b){return __call(c,function(_c){return a(_b,_c);});});})`,
	cases: {
...
compiledTest("await logical both", {
	...
	output: `__async(function(left,right){return __call(left,function(_left){return __await(_left?right():0,function(_right){return _left&&_right;});});})`,
	cases: {
...
compiledTest("await binary both", {
	input: `async function(left, right) { return await left() + await right(); }`,
	output: `__async(function(left,right){return __call(left,function(_left){return __call(right,function(_right){return _left+_right;});});})`,
	cases: {
...
compiledTest("await binary and logical", {
	...
	output: `__async(function(left,middle,right){return __call(left,function(_left){return __call(middle,function(_middle){var _ref=_left+!_middle;return __await(_ref?right():0,function(_right){return _ref&&_right;});});});})`,
	cases: {
...
compiledTest("if body assignments", {
	...
	output: `__async(function(foo,bar,baz){var result;return __call(function(){return __callIgnored(function(){if(foo()){return __call(bar,function(_bar){result=_bar;});}else{return __call(baz,function(_baz){result=_baz;});}});},function(){return result;});})`,
	cases: {
		consequent: async f => expect(await f(_ => true, async _ => 1, async _ => 0)).toBe(1),
		alternate: async f => expect(await f(_ => false, async _ => 1, async _ => 0)).toBe(0),
	},
...
compiledTest("this expressions", {
	...
	output: `__async(function(){var _this=this;return __await(_this.foo(),function(_this$foo){return __await(_this.bar(),function(_this$bar){return _this$foo+_this$bar;});});})`,
	cases: {
...
compiledTest("catch and await", {
	...
	output: `__async(function(foo,bar){return __call(foo,void 0,function(e){return __callIgnored(bar);});})`,
	cases: {
...
compiledTest("for to length with mutation", {
	...
	output: `__async(function(list){var i=0;return __awaitIgnored(__for(function(){return i<list.length;},function(){return i++;},function(){return __await(list[i](),function(_list$i){if(_list$i){i=list.length;}});}));})`,
	cases: {
		none: async f => expect(await f([])).toBe(undefined),
		single: async f => {
			let called = false;
...
compiledTest("while loop", {
	...
	output: `__async(function(foo){let shouldContinue=true;return __awaitIgnored(__for(function(){return shouldContinue;},void 0,function(){return __call(foo,function(_foo){shouldContinue=_foo;});}));})`,
	cases: {
		one: async f => {
			var count = 0;
...
compiledTest("do while loop", {
	...
	output: `__async(function(foo){let shouldContinue;return __awaitIgnored(__do(function(){return __call(foo,function(_foo){shouldContinue=_foo;});},function(){return shouldContinue;}));})`,
	cases: {
		one: async f => {
			var count = 0;
			expect(await f(async _ => { ++count })).toBe(undefined);
...
compiledTest("for break with identifier", {
	...
	output: `__async(function(foo){var _loopInterrupt;loop:return __awaitIgnored(__for(function(){return!_loopInterrupt;},void 0,function(){return __call(foo,function(){_loopInterrupt=1;});}));})`,
});

compiledTest("switch break with identifier", {
	input: `async function(foo) { exit: switch (0) { default: await foo(); break exit; } }`,
	output: `__async(function(foo){return __awaitIgnored(__switch(0,[[void 0,function(){return __callIgnored(foo);}]]));})`,
});
...
compiledTest("sequence expression", {
	...
	output: `__async(function(left,right){return __call(left,function(_left){return __call(right,function(_right){return _right;});});})`,
	cases: {
		value: async f => {
...
compiledTest("complex hoisting", {
	...
	output: `__async(function(foo,baz){var result;return __call(function(){return __callIgnored(function(){if(foo()){function bar(){return 1;}return __call(bar,function(_bar){result=_bar;});}else{return __call(baz,function(_baz){result=_baz;});}});},function(){return result;});})`,
	cases: {
